...
--
-- Hôte : localhost:3306
-- Généré le : mar. 12 jan. 2021 à 08:44
...
CREATE TABLE `assoc_peuples_habitats` (
  `id` int(11) NOT NULL,
  `assoc_peuple_id` int(11) NOT NULL,
  `assoc_hab_id` int(11) NOT NULL
...
INSERT INTO `assoc_peuples_habitats` (`id`, `assoc_peuple_id`, `assoc_hab_id`) VALUES
(1, 4, 8),
(2, 5, 12),
(3, 6, 12),
(4, 7, 12),
...
INSERT INTO `habitats` (`hab_id`, `hab_name`, `hab_cat_int`) VALUES
(1, 'hutte écran', 1),
(2, 'bateau maison', 1),
(3, 'hutte conique', 1),
(4, 'voûte', 1),
...
CREATE TABLE `peuples` (
  `peuple_id` int(11) NOT NULL,
  `peuple_name` varchar(255) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
ALTER TABLE `habitats`
  ...
  ADD KEY `hab_cat_int` (`hab_cat_int`);
...
--
-- AUTO_INCREMENT pour la table `assoc_peuples_habitats`
--
ALTER TABLE `assoc_peuples_habitats`
...
--
ALTER TABLE `habitats`
  MODIFY `hab_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;

--
-- AUTO_INCREMENT pour la table `peuples`
--
ALTER TABLE `peuples`
  MODIFY `peuple_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
...
--
ALTER TABLE `assoc_peuples_habitats`
  ADD CONSTRAINT `assoc_peuples_habitats_ibfk_1` FOREIGN KEY (`assoc_peuple_id`) REFERENCES `peuples` (`peuple_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `assoc_peuples_habitats_ibfk_2` FOREIGN KEY (`assoc_hab_id`) REFERENCES `habitats` (`hab_id`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Contraintes pour la table `habitats`
--
ALTER TABLE `habitats`
  ADD CONSTRAINT `habitats_ibfk_1` FOREIGN KEY (`hab_cat_int`) REFERENCES `categories` (`cat_id`) ON DELETE CASCADE ON UPDATE CASCADE;
COMMIT;
